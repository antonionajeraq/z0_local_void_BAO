...
Running CLASS in a grid to obtain the recombination and decoupling temperatures. Order of operations:

CLASS_Tstar_decoupling runs the parameter grid and saves the values
Quadratic_fitting_grid fits the values using a quadratic form
Saves a file with the rms and maximum absolute deviation from the above quadratic fit. 
